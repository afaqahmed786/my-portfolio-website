...
<h1 className="flex justify-center font-bold text-6xl bg-pink-200   ">About me</h1>
 <h2 className="flex justify-between text-center py-16 px-40 font-bold text-2xl bg-pink-100 text-gray-900 ">
Hi, I’m **Afaq Ahmed**, a passionate website developer with a focus on creating responsive and engaging web experiences. My journey in web development started with building modern, user-friendly websites, and I continue to hone my skills in the latest technologies. 

Currently, I’m diving into new fields like **AI**, **Web 3.0**, and the **Metaverse**, as part of my learning process to stay ahead of the curve in the ever-evolving tech world. My goal is to blend these cutting-edge technologies into future projects, creating innovative digital solution.</h2>
