...
export default function Home() {
  return (
    <main className="bg-purple-200">
      ...
      <div className="flex justify-between bg-yellow-300 py-6 px-3 ga ">
        ...
        <ul className="flex gap-14">
          ...
          <li className="bg-yellow-200 animate-pulse">
            {" "}
            <Link href="/About"> About</Link> 
          </li>
          <li className="bg-yellow-200 animate-pulse"> <Link href="/Contactus">Contactus</Link></li>
        </ul>
      </nav>
      </div>
      <h1 className="font-extrabold text-4xl bg-purple-300 py-10 text-gray-800 text-center animate-pulse">
        {" "}
        HELLO I AM Afaq Ahmed
      </h1>
      
      <section className="flex items-center mx-10">
      <div className=" font-bold text-2xl bg-purple-200 text-gray-700 mx-20  ">
       <p>I am a passionate website developer dedicated to creating responsive
        user-friendly websites that blend creativity with functionality to meet
        clients needs.</p>
        </div>

      <div>
      <Image width={900} height={700} src="/poster.jpeg" alt="Afaq Ahmed" />
